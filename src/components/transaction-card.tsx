...
import { transactionSnapshot } from "@/config/transaction-snapshot";
...
export const TransactionCard = (props: QuoteCardProps) => {
              ...
              <div className="flex flex-col gap-2 py-2">
                ...
                <DraftTransactionForm
                  ...
                  paramsChangeInstruction={{
                    locator: "01J8J7G06KY5H7JQ6HPSTESG69",
                    action: "params",
                    effectiveTime: "2024-09-26T04:00:00Z",
                  }}
                  titles={{
                    formTitle: "Transaction Form",
                  }}
                  productModel={dataModel.products["PersonalAuto"]}
